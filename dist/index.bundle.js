...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  font-family: Avenir, Helvetica, Arial, sans-serif;\n\n  display: grid;\n  grid-template-columns: 1fr 4fr;\n  grid-template-rows: 2fr 17fr 1fr;\n  height: 100vh;\n  width: 100vw;\n  margin: 0;\n}\n\n.header {\n  grid-column: 1 / -1;\n  grid-row: 1 / 2;\n  \n  text-decoration: none;\n  color: white;\n  background-color: #065f46;\n  font-size: 3rem;\n  padding: 1rem;\n\n  display: flex;\n  align-items: center;\n}\n\n.selected {\n  font-weight: bold;\n}\n\n.sidebar {\n  grid-column: 1 / 2;\n  grid-row: 2 / 3;\n\n  display: flex;\n  flex-direction: column;\n  gap: 20px;\n  justify-content: flex-start;\n  align-items: flex-start;\n\n  padding: 1rem;\n  background-color: #f3f4f6;\n  border-right: 1px solid #d1d5db;\n  font-size: 1.75rem;\n  width: 20vw;\n}\n\n.project-names {\n  list-style-type: none;\n  margin: 0;\n  padding: 0;\n  padding-left: 1rem;\n\n  font-size: 1.5rem;\n\n  display: flex;\n  flex-direction: column;\n}\n\n.sidebar > div:hover,\n.project-names:hover {\n  cursor: pointer;\n}\n\n.sidebar > button {\n  margin-top: 3rem;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  border-radius: 3rem;\n  font-size: 3rem;\n  width: 4rem;\n  height: 4rem;\n}\n\n.content {\n  grid-column: 2 / 3;\n  grid-row: 2 / 3;\n\n  /* width: 80vw; */\n}\n\n.footer {\n  grid-column: 1 / 3;\n  grid-row: 3 / 4;\n\n  background-color: #d1d5db;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.add-window {\n  display: grid;\n  grid-template-columns: 2fr 4fr 1fr;\n  grid-template-rows: 1fr 1fr 1fr 1fr 5fr;\n\n  height: 350px;\n  width: 500px;\n\n  border: #d1d5db 2px solid;\n  border-radius: 10px;\n\n  position: fixed;\n  top: 20vh;\n  left: 25vw;\n  background-color: white;\n}\n\n.new-tabs {\n  grid-column: 1 / 2;\n  grid-row: 1 / -1;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  border-right: #d1d5db 2px solid;\n}\n\n.new-todo,\n.new-project,\n.new-note {\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  background-color: white;\n  text-align: center;\n  font-size: 1.25rem;\n  height: 75px;\n}\n\n.new-note {\n  border: 0;\n}\n\n.add-todo-form {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 3fr 1fr 1fr 1fr;\n\n  width: 90%;\n  height: 90%;\n  place-self: center;\n}\n\n.add-todo-form > #todo-title {\n  grid-row: 1 / 2;\n  grid-column: 1 / -1;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.add-todo-form > #todo-text {\n  grid-row: 2 / 3;\n  grid-column: 1 / -1;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.add-todo-form > #due-date {\n  grid-row: 3 / 4;\n  grid-column: 1 / -1;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.add-todo-form > #projects {\n  grid-row: 4 / 5;\n  grid-column: 1 / 2;\n  font: inherit;\n  border: 0;\n  margin-right: 15px;\n  color: #8e8e8e;\n}\n.add-todo-form > #priority {\n  grid-row: 4 / 5;\n  grid-column: 2 / 3;\n  font: inherit;\n  border: 0;\n  margin-left: 15px;\n  color: #8e8e8e;\n}\n.add-todo-form > .submit-todo,\n.add-project-form > .submit-project,\n.add-note-form > .submit-note {\n  grid-row: -2 / -1;\n  grid-column: 1 / -1;\n  place-self: center end;\n\n  font: inherit;\n  font-weight: bold;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  border-radius: 10px;\n  width: 100px;\n  height: 35px;\n  margin: 10px;\n}\n\n.add-project-form {\n  display: grid;\n  grid-template-rows: 1fr 1fr;\n  height: 60%;\n  width: 90%;\n  place-self: center;\n}\n.add-project-form > #project-title {\n  grid-row: 1 / 2;\n  height: 1.5rem;\n  border: 0;\n  font: inherit;\n  border-bottom: #d1d5db 1px solid;\n}\n\n.add-note-form {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 3fr 1fr;\n  width: 90%;\n  place-self: center;\n}\n\n.add-note-form > #note-title {\n  grid-column: 1 / -1;\n  grid-row: 1 / 2;\n  height: 1.5rem;\n  align-self: end;\n  border: 0;\n  font: inherit;\n  border-bottom: #d1d5db 1px solid;\n}\n.add-note-form > #note-text {\n  grid-column: 1 / -1;\n  grid-row: 2 / 3;\n  height: 3rem;\n  border: 0;\n  font: inherit;\n}\n.add-note-form > .note-submit {\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n}\n\n.todos-page {\n  display: flex;\n  flex-direction: column;\n}\n\n.todo-item {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  gap: 35px;\n\n  background-color: #f3f4f6;\n  border-radius: 5px;\n  padding: 5px;\n  margin: 10px;\n\n  width: 75vw;\n}\n.todo-item > .title {\n  width: 100%;\n  overflow: hidden;\n}\n\n.todo-item > .priority-indicator {\n  width: 10px;\n  height: 25px;\n  border-radius: 5px;\n}\n\n.notes-page {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  gap: 15px;\n  padding: 15px;\n}\n\n.note-item {\n  background-color: #f3f4f6;\n  border-radius: 5px;\n  display: grid;\n  grid-template-columns: 4fr 1fr;\n  grid-template-rows: 1fr 3fr 1fr;\n  width: 200px;\n  height: 200px;\n  padding: 10px;\n}\n.note-item > .title {\n  grid-column: 1 / 3;\n  grid-row: 1 / 2;\n  overflow: hidden;\n  border-bottom: #d1d5db 1px solid;\n  align-self: center;\n  padding-bottom: 5px;\n  font-weight: 500;\n  white-space: nowrap;\n}\n.note-item > .text {\n  grid-column: 1 / 3;\n  grid-row: 2 / 3;\n  overflow: hidden;\n  padding-top: 5px;\n}\n.note-item > .edit {\n  grid-column: 1 / 2;\n  grid-row: 3 / 4;\n  align-self: center;\n  justify-self: end;\n}\n.note-item > .remove {\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  align-self: center;\n  justify-self: end;\n}\n\n.edit-todo-window {\n  height: 350px;\n  width: 500px;\n\n  border: #d1d5db 2px solid;\n  border-radius: 10px;\n\n  position: fixed;\n  top: 20vh;\n  left: 25vw;\n  background-color: white;\n}\n.edit-todo-form {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 1fr 3fr 1fr 1fr 1fr;\n\n  height: 70%;\n  margin: 15px;\n}\n.edit-todo-form > #edit-title {\n  grid-row: 2 / 3;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-todo-form > #edit-text {\n  grid-row: 3 / 4;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-todo-form > #edit-date {\n  grid-row: 4 / 5;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-todo-form > #edit-projects {\n  grid-row: 5 / 6;\n  grid-column: 1 / 2;\n  font: inherit;\n  border: 0;\n  margin-right: 15px;\n  color: #8e8e8e;\n}\n.edit-todo-form > #edit-priority {\n  grid-row: 5 / 6;\n  grid-column: 2 / 3;\n  font: inherit;\n  border: 0;\n  margin-left: 15px;\n  color: #8e8e8e;\n}\n.edit-todo-form > .save {\n  grid-row: 6 / 7;\n  grid-column: 2 / 3;\n  place-self: center end;\n\n  font: inherit;\n  font-weight: bold;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  border-radius: 10px;\n  width: 125px;\n  height: 35px;\n  margin: 10px;\n\n  display: grid;\n  place-items: center;\n}\n.edit-todo-form > .close-edit {\n  grid-row: 1 / 2;\n  grid-column: 2 / 3;\n  place-self: center end;\n\n  border-radius: 20px;\n  width: 40px;\n  height: 40px;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  font-size: 2rem;\n\n  display: grid;\n  place-content: center;\n}\n\n.edit-note-window {\n  height: 350px;\n  width: 500px;\n\n  border: #d1d5db 2px solid;\n  border-radius: 10px;\n\n  position: fixed;\n  top: 20vh;\n  left: 25vw;\n  background-color: white;\n}\n.edit-note-form {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 1fr 3fr 1fr;\n\n  height: 90%;\n  margin: 15px;\n}\n.edit-note-form > #edit-title {\n  grid-row: 2 / 3;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-note-form > #edit-text {\n  grid-row: 3 / 4;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-note-form > .save {\n  grid-row: 4 / 5;\n  grid-column: 2 / 3;\n  place-self: center end;\n\n  font: inherit;\n  font-weight: bold;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  border-radius: 10px;\n  width: 125px;\n  height: 35px;\n  margin: 10px;\n\n  display: grid;\n  place-items: center;\n}\n.edit-note-form > .close-edit {\n  grid-row: 1 / 2;\n  grid-column: 2 / 3;\n  place-self: center end;\n\n  border-radius: 20px;\n  width: 40px;\n  height: 40px;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  font-size: 2rem;\n\n  display: grid;\n  place-content: center;\n}\n\n.add-todo-form,\n.add-project-form,\n.add-note-form,\n.edit-todo-window,\n.edit-note-window {\n  grid-column: 2 / 3;\n  grid-row: 2 / -1;\n}\n\n.add-window,\n.add-project-form,\n.add-note-form,\n.edit-todo-window,\n.edit-note-window {\n  display: none;\n}\n\n.close {\n  grid-column: 3 / 4;\n  grid-row: 1 / 3;\n  place-self: center;\n\n  border-radius: 20px;\n  width: 40px;\n  height: 40px;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  font-size: 2rem;\n}\n\nbutton {\n  cursor: pointer;\n}\n\n.notes-page {\n  display: none;\n}\n\n.todo-item > img,\n.note-item > img {\n  width: 1.5rem;\n  height: auto;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,iDAAiD;;EAEjD,aAAa;EACb,8BAA8B;EAC9B,gCAAgC;EAChC,aAAa;EACb,YAAY;EACZ,SAAS;AACX;;AAEA;EACE,mBAAmB;EACnB,eAAe;;EAEf,qBAAqB;EACrB,YAAY;EACZ,yBAAyB;EACzB,eAAe;EACf,aAAa;;EAEb,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,eAAe;;EAEf,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,2BAA2B;EAC3B,uBAAuB;;EAEvB,aAAa;EACb,yBAAyB;EACzB,+BAA+B;EAC/B,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,qBAAqB;EACrB,SAAS;EACT,UAAU;EACV,kBAAkB;;EAElB,iBAAiB;;EAEjB,aAAa;EACb,sBAAsB;AACxB;;AAEA;;EAEE,eAAe;AACjB;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;EACzB,YAAY;EACZ,SAAS;EACT,mBAAmB;EACnB,eAAe;EACf,WAAW;EACX,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,eAAe;;EAEf,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,eAAe;;EAEf,yBAAyB;EACzB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,kCAAkC;EAClC,uCAAuC;;EAEvC,aAAa;EACb,YAAY;;EAEZ,yBAAyB;EACzB,mBAAmB;;EAEnB,eAAe;EACf,SAAS;EACT,UAAU;EACV,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,gBAAgB;;EAEhB,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;EACnB,+BAA+B;AACjC;;AAEA;;;EAGE,SAAS;EACT,gCAAgC;EAChC,uBAAuB;EACvB,kBAAkB;EAClB,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,SAAS;AACX;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,uCAAuC;;EAEvC,UAAU;EACV,WAAW;EACX,kBAAkB;AACpB;;AAEA;EACE,eAAe;EACf,mBAAmB;EACnB,aAAa;EACb,SAAS;EACT,gCAAgC;EAChC,cAAc;AAChB;AACA;EACE,eAAe;EACf,mBAAmB;EACnB,aAAa;EACb,SAAS;EACT,gCAAgC;EAChC,cAAc;AAChB;AACA;EACE,eAAe;EACf,mBAAmB;EACnB,aAAa;EACb,SAAS;EACT,gCAAgC;EAChC,cAAc;AAChB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,SAAS;EACT,kBAAkB;EAClB,cAAc;AAChB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,SAAS;EACT,iBAAiB;EACjB,cAAc;AAChB;AACA;;;EAGE,iBAAiB;EACjB,mBAAmB;EACnB,sBAAsB;;EAEtB,aAAa;EACb,iBAAiB;EACjB,yBAAyB;EACzB,YAAY;EACZ,SAAS;EACT,mBAAmB;EACnB,YAAY;EACZ,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,aAAa;EACb,2BAA2B;EAC3B,WAAW;EACX,UAAU;EACV,kBAAkB;AACpB;AACA;EACE,eAAe;EACf,cAAc;EACd,SAAS;EACT,aAAa;EACb,gCAAgC;AAClC;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,+BAA+B;EAC/B,UAAU;EACV,kBAAkB;AACpB;;AAEA;EACE,mBAAmB;EACnB,eAAe;EACf,cAAc;EACd,eAAe;EACf,SAAS;EACT,aAAa;EACb,gCAAgC;AAClC;AACA;EACE,mBAAmB;EACnB,eAAe;EACf,YAAY;EACZ,SAAS;EACT,aAAa;AACf;AACA;EACE,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,SAAS;;EAET,yBAAyB;EACzB,kBAAkB;EAClB,YAAY;EACZ,YAAY;;EAEZ,WAAW;AACb;AACA;EACE,WAAW;EACX,gBAAgB;AAClB;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,eAAe;EACf,SAAS;EACT,aAAa;AACf;;AAEA;EACE,yBAAyB;EACzB,kBAAkB;EAClB,aAAa;EACb,8BAA8B;EAC9B,+BAA+B;EAC/B,YAAY;EACZ,aAAa;EACb,aAAa;AACf;AACA;EACE,kBAAkB;EAClB,eAAe;EACf,gBAAgB;EAChB,gCAAgC;EAChC,kBAAkB;EAClB,mBAAmB;EACnB,gBAAgB;EAChB,mBAAmB;AACrB;AACA;EACE,kBAAkB;EAClB,eAAe;EACf,gBAAgB;EAChB,gBAAgB;AAClB;AACA;EACE,kBAAkB;EAClB,eAAe;EACf,kBAAkB;EAClB,iBAAiB;AACnB;AACA;EACE,kBAAkB;EAClB,eAAe;EACf,kBAAkB;EAClB,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,YAAY;;EAEZ,yBAAyB;EACzB,mBAAmB;;EAEnB,eAAe;EACf,SAAS;EACT,UAAU;EACV,uBAAuB;AACzB;AACA;EACE,aAAa;EACb,8BAA8B;EAC9B,2CAA2C;;EAE3C,WAAW;EACX,YAAY;AACd;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,SAAS;EACT,gCAAgC;EAChC,cAAc;AAChB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,SAAS;EACT,gCAAgC;EAChC,cAAc;AAChB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,SAAS;EACT,gCAAgC;EAChC,cAAc;AAChB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,SAAS;EACT,kBAAkB;EAClB,cAAc;AAChB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,SAAS;EACT,iBAAiB;EACjB,cAAc;AAChB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,sBAAsB;;EAEtB,aAAa;EACb,iBAAiB;EACjB,yBAAyB;EACzB,YAAY;EACZ,SAAS;EACT,mBAAmB;EACnB,YAAY;EACZ,YAAY;EACZ,YAAY;;EAEZ,aAAa;EACb,mBAAmB;AACrB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,sBAAsB;;EAEtB,mBAAmB;EACnB,WAAW;EACX,YAAY;EACZ,yBAAyB;EACzB,YAAY;EACZ,SAAS;EACT,eAAe;;EAEf,aAAa;EACb,qBAAqB;AACvB;;AAEA;EACE,aAAa;EACb,YAAY;;EAEZ,yBAAyB;EACzB,mBAAmB;;EAEnB,eAAe;EACf,SAAS;EACT,UAAU;EACV,uBAAuB;AACzB;AACA;EACE,aAAa;EACb,8BAA8B;EAC9B,mCAAmC;;EAEnC,WAAW;EACX,YAAY;AACd;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,SAAS;EACT,gCAAgC;EAChC,cAAc;AAChB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,SAAS;EACT,gCAAgC;EAChC,cAAc;AAChB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,sBAAsB;;EAEtB,aAAa;EACb,iBAAiB;EACjB,yBAAyB;EACzB,YAAY;EACZ,SAAS;EACT,mBAAmB;EACnB,YAAY;EACZ,YAAY;EACZ,YAAY;;EAEZ,aAAa;EACb,mBAAmB;AACrB;AACA;EACE,eAAe;EACf,kBAAkB;EAClB,sBAAsB;;EAEtB,mBAAmB;EACnB,WAAW;EACX,YAAY;EACZ,yBAAyB;EACzB,YAAY;EACZ,SAAS;EACT,eAAe;;EAEf,aAAa;EACb,qBAAqB;AACvB;;AAEA;;;;;EAKE,kBAAkB;EAClB,gBAAgB;AAClB;;AAEA;;;;;EAKE,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,eAAe;EACf,kBAAkB;;EAElB,mBAAmB;EACnB,WAAW;EACX,YAAY;EACZ,yBAAyB;EACzB,YAAY;EACZ,SAAS;EACT,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;AACf;;AAEA;;EAEE,aAAa;EACb,YAAY;AACd","sourcesContent":["body {\n  font-family: Avenir, Helvetica, Arial, sans-serif;\n\n  display: grid;\n  grid-template-columns: 1fr 4fr;\n  grid-template-rows: 2fr 17fr 1fr;\n  height: 100vh;\n  width: 100vw;\n  margin: 0;\n}\n\n.header {\n  grid-column: 1 / -1;\n  grid-row: 1 / 2;\n  \n  text-decoration: none;\n  color: white;\n  background-color: #065f46;\n  font-size: 3rem;\n  padding: 1rem;\n\n  display: flex;\n  align-items: center;\n}\n\n.selected {\n  font-weight: bold;\n}\n\n.sidebar {\n  grid-column: 1 / 2;\n  grid-row: 2 / 3;\n\n  display: flex;\n  flex-direction: column;\n  gap: 20px;\n  justify-content: flex-start;\n  align-items: flex-start;\n\n  padding: 1rem;\n  background-color: #f3f4f6;\n  border-right: 1px solid #d1d5db;\n  font-size: 1.75rem;\n  width: 20vw;\n}\n\n.project-names {\n  list-style-type: none;\n  margin: 0;\n  padding: 0;\n  padding-left: 1rem;\n\n  font-size: 1.5rem;\n\n  display: flex;\n  flex-direction: column;\n}\n\n.sidebar > div:hover,\n.project-names:hover {\n  cursor: pointer;\n}\n\n.sidebar > button {\n  margin-top: 3rem;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  border-radius: 3rem;\n  font-size: 3rem;\n  width: 4rem;\n  height: 4rem;\n}\n\n.content {\n  grid-column: 2 / 3;\n  grid-row: 2 / 3;\n\n  /* width: 80vw; */\n}\n\n.footer {\n  grid-column: 1 / 3;\n  grid-row: 3 / 4;\n\n  background-color: #d1d5db;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.add-window {\n  display: grid;\n  grid-template-columns: 2fr 4fr 1fr;\n  grid-template-rows: 1fr 1fr 1fr 1fr 5fr;\n\n  height: 350px;\n  width: 500px;\n\n  border: #d1d5db 2px solid;\n  border-radius: 10px;\n\n  position: fixed;\n  top: 20vh;\n  left: 25vw;\n  background-color: white;\n}\n\n.new-tabs {\n  grid-column: 1 / 2;\n  grid-row: 1 / -1;\n\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  border-right: #d1d5db 2px solid;\n}\n\n.new-todo,\n.new-project,\n.new-note {\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  background-color: white;\n  text-align: center;\n  font-size: 1.25rem;\n  height: 75px;\n}\n\n.new-note {\n  border: 0;\n}\n\n.add-todo-form {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 3fr 1fr 1fr 1fr;\n\n  width: 90%;\n  height: 90%;\n  place-self: center;\n}\n\n.add-todo-form > #todo-title {\n  grid-row: 1 / 2;\n  grid-column: 1 / -1;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.add-todo-form > #todo-text {\n  grid-row: 2 / 3;\n  grid-column: 1 / -1;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.add-todo-form > #due-date {\n  grid-row: 3 / 4;\n  grid-column: 1 / -1;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.add-todo-form > #projects {\n  grid-row: 4 / 5;\n  grid-column: 1 / 2;\n  font: inherit;\n  border: 0;\n  margin-right: 15px;\n  color: #8e8e8e;\n}\n.add-todo-form > #priority {\n  grid-row: 4 / 5;\n  grid-column: 2 / 3;\n  font: inherit;\n  border: 0;\n  margin-left: 15px;\n  color: #8e8e8e;\n}\n.add-todo-form > .submit-todo,\n.add-project-form > .submit-project,\n.add-note-form > .submit-note {\n  grid-row: -2 / -1;\n  grid-column: 1 / -1;\n  place-self: center end;\n\n  font: inherit;\n  font-weight: bold;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  border-radius: 10px;\n  width: 100px;\n  height: 35px;\n  margin: 10px;\n}\n\n.add-project-form {\n  display: grid;\n  grid-template-rows: 1fr 1fr;\n  height: 60%;\n  width: 90%;\n  place-self: center;\n}\n.add-project-form > #project-title {\n  grid-row: 1 / 2;\n  height: 1.5rem;\n  border: 0;\n  font: inherit;\n  border-bottom: #d1d5db 1px solid;\n}\n\n.add-note-form {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 3fr 1fr;\n  width: 90%;\n  place-self: center;\n}\n\n.add-note-form > #note-title {\n  grid-column: 1 / -1;\n  grid-row: 1 / 2;\n  height: 1.5rem;\n  align-self: end;\n  border: 0;\n  font: inherit;\n  border-bottom: #d1d5db 1px solid;\n}\n.add-note-form > #note-text {\n  grid-column: 1 / -1;\n  grid-row: 2 / 3;\n  height: 3rem;\n  border: 0;\n  font: inherit;\n}\n.add-note-form > .note-submit {\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n}\n\n.todos-page {\n  display: flex;\n  flex-direction: column;\n}\n\n.todo-item {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  gap: 35px;\n\n  background-color: #f3f4f6;\n  border-radius: 5px;\n  padding: 5px;\n  margin: 10px;\n\n  width: 75vw;\n}\n.todo-item > .title {\n  width: 100%;\n  overflow: hidden;\n}\n\n.todo-item > .priority-indicator {\n  width: 10px;\n  height: 25px;\n  border-radius: 5px;\n}\n\n.notes-page {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  gap: 15px;\n  padding: 15px;\n}\n\n.note-item {\n  background-color: #f3f4f6;\n  border-radius: 5px;\n  display: grid;\n  grid-template-columns: 4fr 1fr;\n  grid-template-rows: 1fr 3fr 1fr;\n  width: 200px;\n  height: 200px;\n  padding: 10px;\n}\n.note-item > .title {\n  grid-column: 1 / 3;\n  grid-row: 1 / 2;\n  overflow: hidden;\n  border-bottom: #d1d5db 1px solid;\n  align-self: center;\n  padding-bottom: 5px;\n  font-weight: 500;\n  white-space: nowrap;\n}\n.note-item > .text {\n  grid-column: 1 / 3;\n  grid-row: 2 / 3;\n  overflow: hidden;\n  padding-top: 5px;\n}\n.note-item > .edit {\n  grid-column: 1 / 2;\n  grid-row: 3 / 4;\n  align-self: center;\n  justify-self: end;\n}\n.note-item > .remove {\n  grid-column: 2 / 3;\n  grid-row: 3 / 4;\n  align-self: center;\n  justify-self: end;\n}\n\n.edit-todo-window {\n  height: 350px;\n  width: 500px;\n\n  border: #d1d5db 2px solid;\n  border-radius: 10px;\n\n  position: fixed;\n  top: 20vh;\n  left: 25vw;\n  background-color: white;\n}\n.edit-todo-form {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 1fr 3fr 1fr 1fr 1fr;\n\n  height: 70%;\n  margin: 15px;\n}\n.edit-todo-form > #edit-title {\n  grid-row: 2 / 3;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-todo-form > #edit-text {\n  grid-row: 3 / 4;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-todo-form > #edit-date {\n  grid-row: 4 / 5;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-todo-form > #edit-projects {\n  grid-row: 5 / 6;\n  grid-column: 1 / 2;\n  font: inherit;\n  border: 0;\n  margin-right: 15px;\n  color: #8e8e8e;\n}\n.edit-todo-form > #edit-priority {\n  grid-row: 5 / 6;\n  grid-column: 2 / 3;\n  font: inherit;\n  border: 0;\n  margin-left: 15px;\n  color: #8e8e8e;\n}\n.edit-todo-form > .save {\n  grid-row: 6 / 7;\n  grid-column: 2 / 3;\n  place-self: center end;\n\n  font: inherit;\n  font-weight: bold;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  border-radius: 10px;\n  width: 125px;\n  height: 35px;\n  margin: 10px;\n\n  display: grid;\n  place-items: center;\n}\n.edit-todo-form > .close-edit {\n  grid-row: 1 / 2;\n  grid-column: 2 / 3;\n  place-self: center end;\n\n  border-radius: 20px;\n  width: 40px;\n  height: 40px;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  font-size: 2rem;\n\n  display: grid;\n  place-content: center;\n}\n\n.edit-note-window {\n  height: 350px;\n  width: 500px;\n\n  border: #d1d5db 2px solid;\n  border-radius: 10px;\n\n  position: fixed;\n  top: 20vh;\n  left: 25vw;\n  background-color: white;\n}\n.edit-note-form {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  grid-template-rows: 1fr 1fr 3fr 1fr;\n\n  height: 90%;\n  margin: 15px;\n}\n.edit-note-form > #edit-title {\n  grid-row: 2 / 3;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-note-form > #edit-text {\n  grid-row: 3 / 4;\n  grid-column: 1 / 3;\n  font: inherit;\n  border: 0;\n  border-bottom: #d1d5db 1px solid;\n  color: #8e8e8e;\n}\n.edit-note-form > .save {\n  grid-row: 4 / 5;\n  grid-column: 2 / 3;\n  place-self: center end;\n\n  font: inherit;\n  font-weight: bold;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  border-radius: 10px;\n  width: 125px;\n  height: 35px;\n  margin: 10px;\n\n  display: grid;\n  place-items: center;\n}\n.edit-note-form > .close-edit {\n  grid-row: 1 / 2;\n  grid-column: 2 / 3;\n  place-self: center end;\n\n  border-radius: 20px;\n  width: 40px;\n  height: 40px;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  font-size: 2rem;\n\n  display: grid;\n  place-content: center;\n}\n\n.add-todo-form,\n.add-project-form,\n.add-note-form,\n.edit-todo-window,\n.edit-note-window {\n  grid-column: 2 / 3;\n  grid-row: 2 / -1;\n}\n\n.add-window,\n.add-project-form,\n.add-note-form,\n.edit-todo-window,\n.edit-note-window {\n  display: none;\n}\n\n.close {\n  grid-column: 3 / 4;\n  grid-row: 1 / 3;\n  place-self: center;\n\n  border-radius: 20px;\n  width: 40px;\n  height: 40px;\n  background-color: #065f46;\n  color: white;\n  border: 0;\n  font-size: 2rem;\n}\n\nbutton {\n  cursor: pointer;\n}\n\n.notes-page {\n  display: none;\n}\n\n.todo-item > img,\n.note-item > img {\n  width: 1.5rem;\n  height: auto;\n}\n"],"sourceRoot":""}]);
// Exports
...
class Todos {
  ...
  static removeEmptyProject() {
    const projectNames = _projects_js__WEBPACK_IMPORTED_MODULE_2__["default"].list;
    ...
    projectNames.forEach((key) => {
      ...
      if (count === 0 && key.title !== "MAIN") {
        _projects_js__WEBPACK_IMPORTED_MODULE_2__["default"].removeProject(key.title);
      }
  ...
  static filterByDueDate() {
    ...
    todoItems.forEach((key) => {
      ...
      if (date.innerText === (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "dd/MM/yyyy")) {
  ...
  generateDom() {
    ...
    date.className = "date";
    date.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(this.dueDate), "dd/MM/yyyy");
  ...
  editForm(titleDom, dateDom, priorityDom) {
    ...
    saveBtn.addEventListener("click", () => {
      ...
      titleDom.innerText = titleForm.value;
      dateDom.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(dateForm.value), "dd/MM/yyyy");
...
const domManipulator = () => {
  const start = () => {
    _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].getStorageData();
    _todos_js__WEBPACK_IMPORTED_MODULE_0__["default"].getStorageData();
    _notes_js__WEBPACK_IMPORTED_MODULE_2__["default"].getStorageData();
  };
  ...
  const generateProject = () => {
    const project = new _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"](
  ...
  const checkAvailability = (obj) => {
    let available = true;
    if (obj === "todo") {
      _todos_js__WEBPACK_IMPORTED_MODULE_0__["default"].list.forEach((key) => {
        if (
      ...
      _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].list.forEach((key) => {
        if (
          key.title.toLowerCase() ===
      ...
      _notes_js__WEBPACK_IMPORTED_MODULE_2__["default"].list.forEach((key) => {
        if (
          key.title.toLowerCase() ===
